CREATE TABLE Pessoa (
 ...
 CONSTRAINT FKPessoaIdArquivoFoto FOREIGN KEY (IdArquivoFoto) REFERENCES ArquivoFoto(Id),
 CONSTRAINT FKPessoaIdNaturalidade FOREIGN KEY (IdNaturalidade) REFERENCES Naturalidade(Id),
);